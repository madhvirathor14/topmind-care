...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#FDFBF5] border-t border-gray-200">
      {/* Top Row */}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Mindfulness and meditation platform for children aged 4-14.
                Building focus, creativity, and confidence through art-based
                practices.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-600">
              © 2025 Topmind Care. All rights reserved. Safe, ad-free
